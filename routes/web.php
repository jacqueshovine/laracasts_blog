...
// Admin
// All these routes use the same middleware
Route::middleware('can:admin')->group(function () {

    // There are 7 actions for a resourceful controller. We can reference them all with the route resource helper.
    // In this case, we had no show action, so we exclude it.
